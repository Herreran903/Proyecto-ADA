...
class ArbolRojoNegro:
    ...
    def insertar(self, parte: arbolParte):
        nuevo_nodo = Nodo(parte.suma(), parte, 'ROJO', self.NIL, self.NIL, self.NIL)
    ...
    def insertarPartes(self, partes: list[arbolParte]):
        for parte in partes:
            self.insertar(parte)